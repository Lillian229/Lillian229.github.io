...
1. `alert([content])` 
    ...
    ```
    ![](https://gitee.com/leelillian/picgorepo/raw/master/images/20220308180045.png)
...
2. `confirm`
    ...
    ```
    ![](https://gitee.com/leelillian/picgorepo/raw/master/images/20220308180201.png)
...
3. `prompt`
    ...
    console.log(reason);
    ```
    ![](https://gitee.com/leelillian/picgorepo/raw/master/images/20220308180538.png)
    ![](https://gitee.com/leelillian/picgorepo/raw/master/images/20220308180609.png)
